...
border-primary"
    ...
    <a href="{{ route('siswa.dashboard') }}"
        class="row d-flex align-items-center justify-content-center text-center w-100" style="height: 45px">
        <div class="col">
    ...
    <a href="{{ $absen_url }}" class="row d-flex align-items-center justify-content-center text-center w-100"
        style="height: 45px">
        <div class="col">
